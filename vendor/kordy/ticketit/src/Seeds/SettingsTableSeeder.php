...
class SettingsTableSeeder extends Seeder
{
    ...
    public function getDefaults()
    {
        return [
            ...
            'email.header'           => 'Ticket actualizado',
            'email.signoff'          => 'Gracias por tu paciencia',
            'email.signature'        => 'Tus amigos',
            'email.dashboard'        => 'Panel de control',
            ...
            'email.footer'           => 'Centro universitario CIFE',
            'email.footer_link'      => 'https://github.com/thekordy/ticketit',
            'email.color_body_bg'    => '#FFFFFF',
            'email.color_header_bg'  => '#23485b',
            'email.color_content_bg' => '#23485b',
            'email.color_footer_bg'  => '#414141',
            'email.color_button_bg'  => '#23485b',
            /*
