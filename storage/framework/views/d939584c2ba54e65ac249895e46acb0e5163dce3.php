...
<?php echo CollectiveForm::model($configuration, ['route' => [$setting->grab('admin_route').'.configuration.update', $configuration->id], 'method' => 'patch']); ?>
            ...
            <div class="form-group">
                ...
                <div class="col-sm-9">
                    ...
                    <span class="help-block" style="color: red;"><?php echo app('translator')->getFromJson('ticketit::admin.config-edit-eval-warning'); ?> <code>eval('$value = serialize(' . $value . ');')</code></span>
                </div>
            </div>
