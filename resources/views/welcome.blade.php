        ...
        <div class="flex-center position-ref full-height image-background">
            @if (Route::has('login'))
                <div class="top-right links">
                    @if (Auth::check())
                        <a href="{{ url('/home') }}"><small class="white-text">Home</small></a>
                    @else
                        <a href="{{ url('/login') }}"><small class="white-text">Iniciar sesión</small></a>
                        <a href="{{ url('/register') }}"><small class="white-text">Registrarse</small></a>
                    @endif
                </div>
            @endif
            ...
            <div class="content">
                ...
                <div class="links">
                  <a class="orange orange-border" href="//www.cife.edu.mx/mesa-de-ayuda"><small class="white-text">Mesa de ayuda</small></a>
                    <a class="orange orange-border" href="{{ url('/login') }}"><small class="white-text">Mis tickets</small></a>
                </div>
            </div>
        </div>
    </body>
